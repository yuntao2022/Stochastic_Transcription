...
# Generate and fill upper triangular part (offsets 1 to 2)
for i in range(1, 3):  # i is the offset (1 to 2)
    np.random.seed(42 + i)
    diag = np.random.uniform(low=0, high=2, size=N - i)
    for k in range(N - i):
        D0_3c[k, k + i] = diag[k]

# Generate and fill lower triangular part (offsets -1 to -2)
for i in range(1, 4):  # i is the absolute value of offset (1 to 2)
    np.random.seed(42 - i)
    diag = np.random.uniform(low=0, high=2, size=N - i)
    for k in range(N - i):
        D0_3c[k + i, k] = diag[k]
...
# Generate and fill upper triangular part (offsets 1 to 3)
for i in range(1, 4):  # i is the offset (1 to 3)
    np.random.seed(42 + i)
    diag = np.random.uniform(low=0, high=3, size=N - i)
    for k in range(N - i):
        D1_3c[k, k + i] = diag[k]

# Generate and fill lower triangular part (offsets -1 to -3)
for i in range(1, 4):  # i is the absolute value of offset (1 to 3)
    np.random.seed(42 - i)
    diag = np.random.uniform(low=0, high=2, size=N - i)
    for k in range(N - i):
        D1_3c[k + i, k] = diag[k]
...
# Generate and fill upper triangular part (offsets 1 to 20)
for i in range(1, 21):  # i is the offset (1 to 20)
    np.random.seed(42 + i)
    diag = np.random.uniform(low=0, high=2, size=N - i)
    for k in range(N - i):
        D0_3d[k, k + i] = diag[k]

# Generate and fill lower triangular part (offsets -1 to -20)
for i in range(1, 21):  # i is the absolute value of offset (1 to 20)
    np.random.seed(42 - i)
    diag = np.random.uniform(low=0, high=2, size=N - i)
    for k in range(N - i):
        D0_3d[k + i, k] = diag[k]
...
# Generate and fill upper triangular part (offsets 1 to 5)
for i in range(1, 6):  # i is the offset (1 to 5)
    np.random.seed(42 + i)
